...
The following replacement photographs were downloaded from Wikimedia Commons and are stored locally in `images/replacements/`.

- `battery-mechanic.webp` — [Auto mechanic checking old car battery voltage](https://commons.wikimedia.org/wiki/File:Auto_mechanic_checking_old_car_battery_voltage.jpg), Shixart1985, [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/).
- `car-battery.webp` — [Car battery](https://commons.wikimedia.org/wiki/File:Car_battery.jpg), Azorbli, [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
- `battery-charging.webp` — [Car battery charging 20180405](https://commons.wikimedia.org/wiki/File:Car_battery_charging_20180405.jpg), Santeri Viinamäki, [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
- `auxiliary-battery-charger.webp` — [Auxiliary Battery & CTEK charger](https://commons.wikimedia.org/wiki/File:Auxiliary_Battery_%26_CTEK_charger.jpg), Stephan Ridgway, [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/).
- `solar-panels.webp` — [Solar-panel photograph](https://unsplash.com/photos/513dBrMJ_5w), Andreas Gücklhorn, [Unsplash License](https://unsplash.com/license).
...
`images/MillenniumBattery3.png` is an existing Millennium Battery Express storefront photograph from the repository. Brand logos under `assets/images/brands/` were recovered from the site's archived assets and remain trademarks of their respective owners.
